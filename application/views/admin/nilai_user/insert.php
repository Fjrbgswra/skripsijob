<?php $this->session->userdata('logged_in_user')['nama'] ?>
<div class="content">
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-info">
            ...
            <p class="card-category"> Masukkan Nilai sesuai dengan keterangan yang dibutuhkan</p>
          </div>
          <div class="card-body">
            <form action="" method="post" enctype="multipart/form-data">
              <div class="col-sm-4">
                ...
                <div class="form-group">
                  <label> Usia </label>
                  <input class="form-control" id="new-pass-control" placeholder="Masukkan Usia Anda" name="kriteria1"  type="number" step = "1" value="" >
