        ...
        <div class="intro-text">
          ...
          <?php if ($this->session->userdata('logged_in_user') != null): ?>
            <?php if($this->session->userdata('logged_in_user')['status'] == 0): ?>
              ...
              <?php else: ?>
                <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="<?php echo site_url('Nilai/create_user/').$this->session->userdata('logged_in_user')['id_pelamar'] ?>">Masukkan Data Nilai</a>
              <?php endif ?>
              <?php else: ?>
              <?php endif ?>
            </div>
